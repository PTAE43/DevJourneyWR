    ...
    return (
        <nav className="bg-white shadow-md px-6 py-4 relative z-50">
            <div className="flex justify-between items-center">
                <div>
                    <img src="/src/assets/image-header/hh..png" alt="Logo" className="w-[24px] h-auto" />
                </div>
                ...
                <ul className={`transition-all duration-300 ease-in-out transform md:flex md:space-x-6 md:static md:translate-x-0 md:opacity-100 
                    ...
                    absolute top-full left-0 w-full h-[200px] bg-[var(--color-bg-menu-toggle-mb)] md:bg-transparent md:flex-row flex flex-col justify-center items-center shadow-md px-5 gap-6`}>
